            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="id_produksi" id="id_produksi" class="form-control" placeholder="Contoh: PRS001"
                            value="<?= $inputs['id_produksi'] ?? '' ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="tanggal_produksi">Tanggal Produksi</label>
                        <input type="date" name="tanggal_produksi" id="tanggal_produksi" class="form-control"
                            value="<?= $inputs['tanggal_produksi'] ?? date('Y-m-d') ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="keterangan">Keterangan</label>
                        <textarea name="keterangan" id="keterangan" class="form-control" placeholder="Keterangan tambahan"><?= $inputs['keterangan'] ?? '' ?></textarea>
                    </div>
                ...
                <div class="card-footer">
                    <a href="<?= base_url('hasilproduksi') ?>" class="btn btn-outline-info">Kembali</a>
...
<script>
    ...
    // Inisialisasi satuan jika sudah ada saat load
