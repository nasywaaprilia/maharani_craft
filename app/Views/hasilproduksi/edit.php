        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Edit Hasil Produksi</h3>
                </div>

                <?= form_open('hasilproduksi/update'); ?>
                <div class="card-body">
                    <?= form_hidden('id_produksi', $produksi['id_produksi']); ?>

                    <div class="form-group">
                        <label>Tanggal Produksi</label>
                        <input type="date" name="tanggal_produksi" class="form-control" value="<?= esc($produksi['tanggal_produksi']) ?>" required>
                    </div>

                    <div class="form-group">
                        <label>Keterangan</label>
                        <textarea name="keterangan" class="form-control" rows="3"><?= esc($produksi['keterangan']) ?></textarea>
                    </div>
                    ...
                    <?php foreach ($detail as $i => $item): ?>
                        <div class="row mb-3 produk-row">
                            ...
                            <div class="col-md-3">
                                <label>Stok</label>
                                <input type="number" name="stok_produk[]" class="form-control" value="<?= esc($item['stok_produk']) ?>" required>
                            </div>
                ...
                <div class="card-footer">
                    <a href="<?= base_url('hasilproduksi'); ?>" class="btn btn-outline-info float-right">Kembali</a>
...
<!-- Script: Update satuan otomatis saat produk diganti -->
<script>
